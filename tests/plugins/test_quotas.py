...
class QuotaListenerTest(QuotaWebTest):
    ...
    def test_quota_tracks_bucket_creation(self):
        ...
        self.assertStatsEqual(
            data,
            {"collection_count": 1, "record_count": 1, "storage_size": storage_size},
        )
    ...
    def test_quota_tracks_collection_creation(self):
        ...
        self.assertStatsEqual(
            data,
            {"collection_count": 1, "record_count": 0, "storage_size": storage_size},
        )
    ...
    def test_tracks_collection_delete_with_multiple_records(self):
        ...
        body = {"data": {"foo": 42}}
        self.app.post_json(
            "{}/records".format(self.collection_uri), body, headers=self.headers
        )
        self.app.post_json(
            "{}/records".format(self.collection_uri), body, headers=self.headers
        )
    ...
    def test_quota_tracks_group_creation(self):
        ...
        self.assertStatsEqual(
            data,
            {"collection_count": 0, "record_count": 0, "storage_size": storage_size},
        )
...
class QuotaBucketRecordMixin:
    def test_507_is_raised_if_quota_exceeded_on_record_creation(self):
        ...
        resp = self.app.post_json(
            "{}/records".format(self.collection_uri),
            body,
        ...
        resp = self.app.get(
            "{}/records".format(self.collection_uri), headers=self.headers
        )
...
class QuotaBucketUpdateMixin:
    def test_507_is_raised_if_quota_exceeded_on_record_update(self):
        ...
        resp = self.app.patch_json(
            self.record_uri, body, headers=self.headers, status=507
        )
    ...
    def test_507_is_raised_if_quota_exceeded_on_collection_update(self):
        ...
        body = {"data": {"foo": 42, "bar": "This is a very long string."}}
        resp = self.app.patch_json(
            self.collection_uri, body, headers=self.headers, status=507
        )
...
class QuotaBucketMixin:
    def test_507_is_raised_if_quota_exceeded_on_collection_creation(self):
        ...
        body = {"data": {"foo": 42}}
        resp = self.app.post_json(
            "{}/collections".format(self.bucket_uri),
            body,
            headers=self.headers,
            status=507,
        )
        ...
        resp = self.app.get(
            "{}/collections".format(self.bucket_uri), headers=self.headers
        )
        assert len(resp.json["data"]) == 1
