...
--
CREATE OR REPLACE FUNCTION as_epoch(ts TIMESTAMP) RETURNS DOUBLE PRECISION AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION from_epoch(epoch DOUBLE PRECISION) RETURNS TIMESTAMP AS $$
BEGIN
