...
class ViewSetTest(unittest.TestCase):
    def test_arguments_are_merged_on_initialization(self):
        ...
        self.assertEquals(viewset.collection_path, mock.sentinel.collection_path)
    ...
    def test_get_service_name_returns_the_viewset_name_if_defined(self):
        ...
        self.assertEquals(
            viewset.get_service_name("record", mock.MagicMock), "fakename-record"
        )
    ...
    def test_get_service_name_returns_resource_att_if_not_callable(self):
        ...
        self.assertEquals(
            viewset.get_service_name("record", resource), "fakename-record"
        )
