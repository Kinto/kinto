...
class OpenAPIRequestsValidationTest(OpenAPITest):
    ...
    def test_validate_bucket_path(self):
        self.assertRaises(
            ...
            unmarshal_request,
            self.request,
            self.resources["Buckets"].get_bucket,
        )
    ...
    def test_validate_groups_path(self):
        self.assertRaises(
            ...
            unmarshal_request,
            self.request,
            self.resources["Groups"].get_groups,
        )
    ...
    def test_validate_batch_requests_body(self):
        self.request._json = {
            "requests": [{"method": "GET", "path": "/buckets/b1", "body": []}]
        }
        self.assertRaises(
            ValidationError,
            unmarshal_request,
    ...
    def test_validate_batch_requests_header(self):
        self.request._json = {
            "requests": [
                {"method": "GET", "path": "/buckets/b1", "body": {}, "headers": []}
            ]
        }
        self.assertRaises(
            ValidationError,
