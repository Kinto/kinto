...
RUN \
    apt-get update; \
    apt-get install -y python3 python3-setuptools python3-pip libpq5 curl; \
    ...
    apt-get remove -y -qq build-essential git python3-dev libssl-dev libffi-dev libpq-dev curl nodejs; \
