...
.. http:post:: /buckets/(bucket_id)/collections
   ...
   **Example Request**
   ...
   .. sourcecode:: bash
      ...
      $ echo '{"data": {"id": "articles"}}' | http POST http://localhost:8888/v1/buckets/blog/collections --auth="token:bob" --verbose
...
.. http:put:: /buckets/(bucket_id)/collections/(collection_id)
    ...
    **Example Request**
    ...
    .. sourcecode:: bash
        ...
        $ http put http://localhost:8888/v1/buckets/blog/collections/articles --auth="token:bob" --verbose
...
.. http:patch:: /buckets/(bucket_id)/collections/(collection_id)
    ...
    **Example Request**
    ...
    .. sourcecode:: bash
        ...
        $ echo '{"data": {"fingerprint": "9cae1b2d0f2b7d09bcf5c1bf51544274"}}' | http patch http://localhost:8888/v1/buckets/blog/collections/articles --auth="token:bob" --verbose
...
.. http:get:: /buckets/(bucket_id)/collections/(collection_id)
    ...
    **Example Request**
    ...
    .. sourcecode:: bash
        ...
        $ http get http://localhost:8888/v1/buckets/blog/collections/articles --auth="token:bob" --verbose
...
.. http:delete:: /buckets/(bucket_id)/collections/(collection_id)
    ...
    **Example Request**
    ...
    .. sourcecode:: bash
        ...
        $ http delete http://localhost:8888/v1/buckets/blog/collections/articles --auth="token:bob" --verbose
...
.. code-block:: bash
    ...
    }' | http PATCH "http://localhost:8888/v1/buckets/default/collections/articles" --auth token:admin --verbose
...
.. code-block:: bash
    ...
    }}' | http POST http://localhost:8888/v1/buckets/blog/collections/articles/records --auth "token:admin"
...
.. code-block:: bash
    ...
    echo '{"data": {"schema": {}} }' | http PATCH "http://localhost:8888/v1/buckets/default/collections/articles" --auth token:admin --verbose
...
.. code-block:: bash
    ...
    echo '{"data": {"cache_expires": 3600} }' | http PATCH "http://localhost:8888/v1/buckets/default/collections/articles" --auth token:admin

From now on, the cache control headers are set for the `GET` requests:

.. code-block:: bash

    http  "http://localhost:8888/v1/buckets/default/collections/articles/records" --auth token:admin
...
.. code-block:: bash
    ...
    echo '{"data": {"cache_expires": 0} }' | http PATCH "http://localhost:8888/v1/buckets/default/collections/articles" --auth token:admin
