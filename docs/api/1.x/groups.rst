...
.. http:post:: /buckets/(bucket_id)/groups
    ...
    **Example Request**
    ...
    .. sourcecode:: bash
        ...
        $ echo '{"data": {"members": ["basicauth:206691a25679e4e1135f16aa77ebcf211c767393c4306cfffe6cc228ac0886b6"]}}' | http POST http://localhost:8888/v1/buckets/blog/groups --auth="token:bob" --verbose
...
.. http:put:: /buckets/(bucket_id)/groups/(group_id)
    ...
    **Example Request**
    ...
    .. sourcecode:: bash
        ...
        $ echo '{"data": {"members": ["basicauth:206691a25679e4e1135f16aa77ebcf211c767393c4306cfffe6cc228ac0886b6"]}}' | http put http://localhost:8888/v1/buckets/blog/groups/readers --auth="token:bob" --verbose
...
.. http:get:: /buckets/(bucket_id)/groups/(group_id)
    ...
    **Example Request**
    ...
    .. sourcecode:: bash
        ...
        $ http get http://localhost:8888/v1/buckets/blog/groups/readers --auth="token:bob" --verbose
...
.. http:get:: /buckets/(bucket_id)/groups
    ...
    **Example Request**
    ...
    .. sourcecode:: bash
        ...
        $ http get http://localhost:8888/v1/buckets/blog/groups --auth="token:bob" --verbose
...
.. http:delete:: /buckets/(bucket_id)/groups/(group_id)
    ...
    **Example Request**
    ...
    .. sourcecode:: bash
        ...
        $ http delete http://localhost:8888/v1/buckets/blog/groups/readers --auth="token:bob" --verbose
